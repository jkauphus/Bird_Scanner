...
C) Set-up BirdNET with the <a href="https://github.com/joeweiss/birdnetlib/tree/main"> birdnetlib conda package</a>.
...
```{r Table, echo=FALSE}
table_name <- "birdNET_results_2023-08-23.xlsx"
...
Again, all these steps on running BirdNET on your ARU calls should be ran through your version of the `bird-scanner.R` script that is provided in the <a href="https://github.com/jkauphus/Bird_Scanner"> Bird-Scanner Repository</a>.
...
![](spectrograms/2_Haemorhous mexicanus_SMM07526_20221213_100202.wav.png){width="350"}
