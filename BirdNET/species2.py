...
if __name__ == '__main__':    
    ...
    # Set config
    cfg.LATITUDE, cfg.LONGITUDE, cfg.WEEK = args_lat, args_lon, args_week
    cfg.LOCATION_FILTER_THRESHOLD = args_threshold
    
    # Set input path    
    cfg.INPUT_PATH = args_i
    ...
    # Get species list
    species_list = getSpeciesList(cfg.LATITUDE, cfg.LONGITUDE, cfg.WEEK, cfg.LOCATION_FILTER_THRESHOLD)
