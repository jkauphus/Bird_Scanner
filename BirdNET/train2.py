...
if __name__ == "__main__":
    ...
    # Config
    cfg.TRAIN_DATA_PATH = args_i
    cfg.CUSTOM_CLASSIFIER = args_o
    cfg.TRAIN_EPOCHS = args_epochs
    cfg.TRAIN_BATCH_SIZE = args_batch_size
    cfg.TRAIN_LEARNING_RATE = args_learning_rate
    cfg.TRAIN_HIDDEN_UNITS = args_hidden_units
